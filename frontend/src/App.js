      ...
      <div className="chat-window" ref={chatWindowRef}>
        {messages.length === 0 && !loading && (
          <div className="placeholder-message">
            Я — ИИ-ассистент. Помогаю с ЖКУ.
            {"\n"}
            Напишите, что вас беспокоит: оплата, начисления, перерасчёты — подскажу, как действовать.
            {"\n"}
            Пожалуйста, не указывайте ФИО, номер счёта и другие личные данные.
          </div>
        )}
        {messages.map((msg, i) => (
          msg.sender === 'ai' ? (
